...
AppData.prototype.showResult = function(){
    ...
    perSelect.addEventListener('input', function(){
        inPer.value = _this.calcSavedMoney();
    }
    );
...
AppData.prototype.clickSubmit = function(){
...
AppData.prototype.enabledInput = function(){
...
AppData.prototype.deleteFields = function(){
...
AppData.prototype.clearField = function(){
    inputFields = document.querySelectorAll('.data  input[type=text]');
    resultFields = document.querySelectorAll('.result  input[type=text]');
    for(let i = 0; i<inputFields.length; i++){
        inputFields[i].value = '';            
...
AppData.prototype.rangeClear = function(){
